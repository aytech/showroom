import { faBars, faShoppingCart, faUser, faUserAlt, faUserCircle } from "@fortawesome/free-solid-svg-icons"
                  ...
                  <ul className="dropdown-menu dropdown-menu-end animate slide mt-3 border-0 shadow">
                    <li>
                      <a className="dropdown-item" href="#">
                        <span className="fw-bold text-decoration-underline">EN</span> English
                      </a>
                    </li>
                    <li>
                      <a className="dropdown-item" href="#">
                        <span className="fw-bold text-decoration-underline">SK</span> Slovenčina
                      </a>
                    </li>
                  </ul>
                </li>
          ...
          <div className="container-fluid padding-side">
            <div className="d-flex justify-content-between align-items-center w-100">
              <a className="navbar-brand" href="index.html">
                <img src="https://place-hold.it/160x30&text=KONSEPTI&bold" className="logo img-fluid" />
              </a>
                ...
                <div className="offcanvas-body align-items-center justify-content-center">
                  ...
                  <ul className="navbar-nav align-items-center mb-2 mb-lg-0">
                    <li className="nav-item px-3">
                      <a className="nav-link active p-0" aria-current="page" href="index.html">Bydlení</a>
                    </li>
                    <li className="nav-item px-3">
                      <a className="nav-link p-0" href="index.html">Kancelář</a>
                    </li>
                    <li className="nav-item px-3">
                      <a className="nav-link p-0" href="index.html">Zahrada</a>
                    </li>
                    <li className="nav-item px-3">
                      <a className="nav-link p-0" href="index.html">Svítidla</a>
                    </li>
                    <li className="nav-item px-3">
                      <a className="nav-link p-0" href="index.html">Doplňky</a>
                    </li>
                    <li className="nav-item px-3">
                      <a className="nav-link p-0" href="index.html">Výprodej</a>
                    </li>
                    <li className="nav-item px-3">
                      <a className="nav-link p-0" href="index.html">Bestsellery</a>
                    </li>
                    <li className="nav-item px-3 dropdown">
                      <a className="nav-link p-0 text-center " data-bs-toggle="dropdown" href="#" role="button"
                        aria-expanded="false">...</a>
                      <ul className="dropdown-menu dropdown-menu-end animate slide mt-3 border-0 shadow">
                        <li>
                          <a className="dropdown-item" href="#">Designéři</a>
                        </li>
                        <li>
                          <a className="dropdown-item" href="#">Inspirace</a>
                        </li>
                        <li>
                          <a className="dropdown-item" href="#">Značky</a>
                        </li>
                      </ul>
                    </li>
                  </ul>
